...
instr_func opcode_entry[256] = {
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_near_i_w, ret_near,
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near , jmp_far_imm, jmp_short_,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, jmp_near_rm_v, inv, push_rm_v, inv};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x84 - 0x87*/ je_near, jne_near, jbe_near, ja_near,
